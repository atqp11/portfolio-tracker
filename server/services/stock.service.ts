...
export class StockService {
  ...
  private transformToDTO(stock: Stock): any {
    ...
    const safeValue = (value: number | null) => (value === null || isNaN(value) ? null : value);
    ...
    return {
      ...
      name: stock.name,
      shares: stock.shares,
      avgPrice: safeValue(stock.avg_price),
      currentPrice: safeValue(stock.current_price),
      previousPrice: safeValue(stock.previous_price),
      actualValue: safeValue(stock.actual_value),
