...
import { thesisRepository, ThesisRepository } from '@/server/repositories/thesis.repository';
...
import { RepositoryError, RepositoryErrorType } from '@/server/repositories/base/types';
import { NotFoundError, ConflictError } from '@/server/middleware/error-handler.middleware'; // Using existing error classes
