...
import { thesisRepository, ThesisRepository } from '@/lib/repositories/thesis.repository';
...
import { NotFoundError, ConflictError } from '@/lib/middleware/error-handler.middleware'; // Using existing error classes
