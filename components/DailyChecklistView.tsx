...
export default function DailyChecklistView({
    ...
    return (
      <details open={defaultOpen} className="group mb-4">
          ...
          <div className="bg-[#0E1114] border border-neutral-800 rounded-lg p-4 hover:border-neutral-700 transition-colors">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-bold text-[#E5E7EB]">{title}</h3>
              ...
              <div className="flex items-center gap-3">
                ...
                <svg
                  className="w-5 h-5 text-[#9CA3AF] group-open:rotate-90 transition-transform"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div className="mt-2 space-y-2 pl-4">
          {tasks.length === 0 ? (
            <p className="text-sm text-[#6B7280] italic py-2">No tasks in this section</p>
          ) : (
            tasks.map((task) => (
              <ChecklistTaskCard
                key={task.id}
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-[#0E1114] border border-neutral-800 rounded-lg p-6">
