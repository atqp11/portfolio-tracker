...
interface EditStockModalProps {
  ...
  stock: Stock | null;
  onClose: () => void;
  onUpdate: (id: string, updates: Partial<Stock>) => Promise<void>;
...
export default function EditStockModal({
  ...
  const handleDelete = async () => {
    ...
    if (!confirm(`Delete ${stock.symbol}? This action cannot be undone.`)) {
      return;
    }
    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Edit Stock</h2>
          <button
            onClick={onClose}
