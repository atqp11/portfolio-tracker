...
/**
 * Error Boundary Component for Investment Thesis Page
 *
 * Provides a fallback UI when errors occur during:
 * - Server-side data fetching
 * - Server Action mutations (create, update, delete, validate)
 * - Component rendering
 *
 * Features:
    ...
    <div className="min-h-[400px] flex items-center justify-center">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 max-w-md w-full">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-center mb-6">
          {error.message || 'An unexpected error occurred while loading your investment theses.'}
        </p>
