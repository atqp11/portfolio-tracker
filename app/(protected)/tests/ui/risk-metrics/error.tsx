...
/**
 * Error Boundary Component for Risk Metrics Test Page
 *
 * Provides a fallback UI when errors occur during:
 * - Server-side portfolio data fetching
 * - Risk metric calculation via Server Actions
 * - Component rendering
 *
 * Features:
 ...
 */
export default function RiskMetricsError({
  error,
  reset,
}: {
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 flex items-center justify-center p-8">
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-8 max-w-md w-full">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-center mb-6">
          {error.message || 'An unexpected error occurred while calculating risk metrics.'}
        </p>
