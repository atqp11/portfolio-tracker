      ...
      <div className="min-h-screen bg-gray-950 text-white p-8">
        <div className="max-w-7xl mx-auto">
          <div className="bg-red-900/20 border border-red-500 rounded-lg p-6">
            ...
            <p className="text-gray-400">Unable to fetch telemetry data. Please try again.</p>
            <button
              onClick={fetchData}
    ...
    <div className="min-h-screen bg-gray-950 text-white p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold mb-2">AI Cost Tracking Dashboard</h1>
        ...
        {/* Warnings */}
        {warnings.length > 0 && (
          <div className="mb-8 bg-yellow-900/20 border border-yellow-500 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-gray-900 rounded-lg p-6 border border-gray-800">
            <h3 className="text-xl font-bold mb-4">Cost by Provider</h3>
            ...
            <div className="mt-4 space-y-2">
              {costByProviderData.map((item) => (
                <div key={item.provider} className="flex justify-between text-sm">
                  ...
                  <span className="font-mono">${item.cost.toFixed(4)} ({item.percentage}%)</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-gray-900 rounded-lg p-6 border border-gray-800">
            <h3 className="text-xl font-bold mb-4">Requests by Task Type</h3>
            <ResponsiveContainer width="100%" height={300}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          {metricsData.map((metric) => (
            <div key={metric.name} className="bg-gray-900 rounded-lg p-6 border border-gray-800">
              <h4 className="text-sm text-gray-400 mb-2">{metric.name}</h4>
        ...
        <div className="mt-8 bg-gray-900 rounded-lg p-6 border border-gray-800">
          <h3 className="text-xl font-bold mb-4">Cost Projections</h3>
...
function MetricRow({ label, value, valueColor = 'text-white' }: {
  label: string;
  value: string;
  valueColor?: string;
}) {
...
function ProjectionCard({ period, cost, target }: {
  ...
  return (
    <div className="bg-gray-800 rounded-lg p-4">
      ...
      <p className={`text-2xl font-bold ${withinTarget ? 'text-green-400' : 'text-red-400'}`}>
        ${cost.toFixed(2)}
      </p>
      {target && (
