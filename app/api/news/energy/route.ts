...
export async function GET() {
  try {
    ...
    if (cache && Date.now() - cache.timestamp < CACHE_DURATION) {
      console.log('Returning cached energy news');
    ...
    console.log('Fetching fresh energy news from NewsAPI...');
    
    // Search for energy-related news
    const query = 'energy OR oil OR natural gas OR petroleum OR crude';
    ...
    console.log(`NewsAPI success: Retrieved ${articles.length} energy articles`);
