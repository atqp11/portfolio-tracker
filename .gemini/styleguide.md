...
This file provides instructions for Gemini Code Assist when working on this project.

## Primary Reference

**Always read and follow the guidelines in:** `docs/0_AI_Coding_Agent_Guide.md`
